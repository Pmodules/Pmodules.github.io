...
include::Building_Pmodules/build-config-files/variants.adoc[leveloffset=+2]
...
== Writing `modulefiles`
include::Building_Pmodules/modulefile.adoc[leveloffset=+2]
...
=== Setup functions
include::Building_Pmodules/functions/add_patch.adoc[leveloffset=+3]
---
include::Building_Pmodules/functions/add_configure_args.adoc[leveloffset=+3]
---
include::Building_Pmodules/functions/add_to_group.adoc[leveloffset=+3]
---
include::Building_Pmodules/functions/set_download_url.adoc[leveloffset=+3]
---
...
=== Other functions (Pmodules 1.0 only)
[NOTE]
====
These functions are deprecated in Pmodules 1.1 and newer!
====
include::Building_Pmodules/functions/compile_in_sourcetree.adoc[leveloffset=+3]
---
include::Building_Pmodules/functions/install_docfile.adoc[leveloffset=+3]
---
include::Building_Pmodules/functions/set_sha256sum.adoc[leveloffset=+3]
---
include::Building_Pmodules/functions/supported_compilers.adoc[leveloffset=+3]
---
include::Building_Pmodules/functions/supported_os.adoc[leveloffset=+3]
---
include::Building_Pmodules/functions/use_autotools.adoc[leveloffset=+3]
---
include::Building_Pmodules/functions/use_cmake.adoc[leveloffset=+3]
---
